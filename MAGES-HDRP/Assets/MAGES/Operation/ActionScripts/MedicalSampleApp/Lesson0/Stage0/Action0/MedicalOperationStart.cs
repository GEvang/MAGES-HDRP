...
public class MedicalOperationStart : MonoBehaviour, IAction
{
    ...
    {
        PrefabImporter.SpawnActionPrefab("MedicalSampleApp/Lesson0/Stage0/Action1/ScalpelPivot");
        PrefabImporter.SpawnActionPrefab("MedicalSampleApp/Lesson0/Stage0/Action1/CauterizerPivot");
        PrefabImporter.SpawnActionPrefab("MedicalSampleApp/Lesson0/Stage0/Action1/DrillPivot");
        PrefabImporter.SpawnActionPrefab("MedicalSampleApp/Lesson0/Stage0/Action1/PliersCotton");
    }
    void EndAction()
    {
