...
public class AdjustInteractableWithCurvesLine : MonoBehaviour {
	...
	void Update () {
        ...
        {
            this.interactable.PickupTransform.position = SampleCurve(startingPosition, OvverideTargetTransform.position, MiddleOvverideTargetTransform.position, GetProgress());
    ...
    Vector3 SampleCurve(Vector3 start, Vector3 end, Vector3 control, float t)
    {
        ...
        return Vector3.Lerp(start,end,t); // Q2 is a point on the curve at time t
    }
