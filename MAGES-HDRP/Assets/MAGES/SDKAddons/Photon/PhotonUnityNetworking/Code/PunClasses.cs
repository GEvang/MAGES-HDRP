...
namespace Photon.Pun
{
    ...
    public interface IPunPrefabPool
    {
        ...
        GameObject Instantiate(string prefabId, GameObject Parent);
    ...
    public class DefaultPool : IPunPrefabPool
    {
        ...
        public GameObject Instantiate(string prefabId, GameObject parent)
        {
            GameObject res = null;
            bool cached = this.ResourceCache.TryGetValue(prefabId, out res);
            if (!cached)
            ...
            GameObject instance = GameObject.Instantiate(res,parent.transform,false) as GameObject;
